...
c---------------------------------------------------------------------------
       CHARACTER*1   kdbug,kdbuga,krnl,kall,kwnd,kmas
...
C
       ...
       DIMENSION    tlon(nst),tlat(nst),thr(nst),typ(nst)
C
       DIMENSION PO(nst)
...
c
       if((flon.ge.flonw).and.(flon.le.flone).and.
...
c
       ...
       typx=typ(ist)+100
       if(iall.eq.1) then
       write(6,611) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),zo(ist),za(ist),zf(ist),zq(ist)
       write(6,612) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),to(ist),ta(ist),tf(ist),tq(ist)
       write(6,613) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),qo(ist),qa(ist),qf(ist),qq(ist)
       else
       write(6,711) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),zo(ist),zq(ist)
       write(6,712) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),to(ist),tq(ist)
       write(6,713) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),qo(ist),qq(ist)
       endif
       endif
c
       endif
...
c
       ...
       typx=typ(ist)+200
       if(iall.eq.1) then
       write(6,614) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),uo(ist),ua(ist),uf(ist),wq(ist)
       write(6,615) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),vo(ist),va(ist),vf(ist)
       else
       write(6,714) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),uo(ist),wq(ist)
       write(6,715) ist,indate,stnid,flon,flat,typx,hr,
     * po(ist),vo(ist)
       endif
       endif
c
...
c
       ...
       CALL CLOSBF(LUNIN)
c
 411   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,4(3e10.2,1x,f3.0,/),3e10.2)
 412   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,3(3e10.2,1x,f3.0,/))
 413   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,3e10.2,1x,f3.0,1x,3e10.2)
c
 511   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,2(e10.2,1x,f3.0),1x,e10.2)
 512   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,3(e10.2,1x,f3.0))
 513   format(a10,1x,f5.2,1x,f5.0,' mb ',1x,e10.2,1x,f3.0,1x,e10.2)
c
 611   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' z ',1x,f6.1,1x,3f10.2,1x,'qf ',f4.0)
 612   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' t ',1x,f6.1,1x,3f10.2,1x,'qf ',f4.0)
 613   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' q ',1x,f6.1,1x,3f10.2,1x,'qf ',f4.0)
 614   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' u ',1x,f6.1,1x,3f10.2,1x,'qf ',f4.0)
 615   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' v ',1x,f6.1,1x,3f10.2)
c
 711   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' z ',1x,f6.1,1x,f10.2,1x,'qf ',f4.0)
 712   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' t ',1x,f6.1,1x,f10.2,1x,'qf ',f4.0)
 713   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' q ',1x,f6.1,1x,f10.2,1x,'qf ',f4.0)
 714   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' u ',1x,f6.1,1x,f10.2,1x,'qf ',f4.0)
 715   format(i6,1x,a10,1x,a8,1x,f6.2,1x,f6.2,1x,f4.0,1x,f5.2,1x,
     * ' v ',1x,f6.1,1x,f10.2)
c
       return
       end
